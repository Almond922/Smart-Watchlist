...
from app.models import User, WatchlistItem, PricePoint, NewsEvent
from app.schemas import UserCreate, WatchlistAdd, SymbolChangeOut
from app.market_data_provider import market_data, UpstreamUnavailable, USING_REAL_DATA
from app.data_source import generate_synthetic_series
from app.scoring import compute_change, ack_snapshot
from app.changes_service import compute_changes_for_user
